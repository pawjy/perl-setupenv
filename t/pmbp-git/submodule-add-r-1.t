...
(perl $pmbp --root-dir-name $tempdir/foo --add-git-submodule-recursively $tempdir/git1 && echo "ok 1") || echo "not ok 1"
(perl $pmbp --root-dir-name $tempdir/foo --add-git-submodule-recursively $tempdir/git1 && echo "ok 2") || echo "not ok 2"
